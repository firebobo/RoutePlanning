...
public class PathEdge {
	...
	public PathEdge (boolean forwards) {
	...
	/**
	 * �ndert die Darstellung der Kanten.
	...
	/**
	 * Sucht �bergebene Kante im Pfad. Falls sie gefunden wird, wird das Pfadelement
	...
	/**
	 * Gibt den Knoten zur�ck, bei dem die Pfadkante endet.
	 * @return Endknoten
	 */
	...
	/**
	 * Gibt die Kante des Pfadelements zur�ck.
	 * @return Kante
	 */
	public Edge getEdge () {
		return edge;
	...
	/**
	 * Gibt die Kantenrichtung zur�ck.
	 * @return Kante vorw�rts gerichtet?
	 */
	public boolean getForwards () {
		return forwards;
	}
	/**
	 * Gint die letzte Kante des Pfads zur�ck.
	 * @return Kante
	 */
	...
	/**
	 * Gibt das folgende Pfadelement zur�ck.
	...
	/**
	 * Gibt das Originalgewicht der Kante zur�ck.
	...
	/**
	 * Gibt den Knoten zur�ck, bei dem die Pfadkante startet.
	 * @return Startknoten
	 */
	...
	/**
	 * Setzt das Feld "next" auf den �bergebenen Pfad.
	 * @param path neuer Folge-Pfad
	 */
	public void setNext (PathEdge path) {
		next = path;
	}
	public void setOrigWeight(double origWeight) {
